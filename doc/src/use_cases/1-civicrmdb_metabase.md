...
[💾 daten-organisieren](./../1-datenlebenszyklus.html#daten-organisieren): [CiviCRM Datenbank](./../tools/civicrm_intern/2-civicrm-datenbank.md) und (partiell) in [Metabase](./../tools/bi-tools.md#metabase) <br>
...
## Anleitung
### Setup
Fügt wie [hier](./../tools/3-bi-tools.md#mb-db-hinzufuegen) beschrieben eine Verbindung zu eurer Datenbank zu Metabase hinzu.



### Daten analysieren und visualisieren
Sobald Metabase Zugriff auf eure CiviCRM-Datenbank habt, könnt ihr *Fragen* erstellen und diese in *Dashboards* visualisieren und darstellen. Mehr zur Analyse und Visualisierung in Metabase [hier](../tools/3-bi-tools.md#mb-daten-analysieren).
