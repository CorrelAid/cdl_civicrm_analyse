...
[💾 daten-organisieren](./../datenlebenszyklus.html#daten-organisieren): [CiviCRM Datenbank](./../tools/civicrm_intern/2-civicrm-datenbank.md) und (partiell) in [Metabase](./../tools/bi-tools.md#metabase) <br>
[🔢 daten-auswerten](./../datenlebenszyklus.html#daten-auswerten): [Metabase](./../tools/bi-tools.md#metabase) <br>
[📊 daten-visualisieren](./../datenlebenszyklus.html#daten-visualisieren): [Metabase](./../tools/bi-tools.md#metabase) <br>
[⚙️ daten-verbinden](./../datenlebenszyklus.html#daten-verbinden): über direkte Anbindung der CiviCRM Datenbank an Metabase
...
## Anleitung
### Setup
Fügt wie [hier](./../tools/bi-tools.md#mb-db-hinzufuegen) beschrieben eine Verbindung zu eurer Datenbank zu Metabase hinzu.



### Daten analysieren und visualisieren
Sobald Metabase Zugriff auf eure CiviCRM-Datenbank habt, könnt ihr *Fragen* erstellen und diese in *Dashboards* visualisieren und darstellen. Mehr zur Analyse und Visualisierung in Metabase [hier](../tools/bi-tools.md#mb-daten-analysieren).
